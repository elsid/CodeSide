...
pub const SIMULATOR_COLLECT_BULLETS_HITS: usize = 0x1 << 5;
...
impl<'r> Simulator<'r> {
    pub fn new(world: &'r World, me_id: i32, flags: usize) -> Self {
        ...
        Simulator {
            ...
            collect_bullets_hits: flags & SIMULATOR_COLLECT_BULLETS_HITS == SIMULATOR_COLLECT_BULLETS_HITS,
        }
    }
