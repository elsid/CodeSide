...
pub struct Config {
    ...
    pub optimal_tile_direct_hit_by_opponent_score_weight: f64,
...
impl Config {
    pub fn new(team_size: i32) -> Self {
        Self {
            ...
            optimal_tile_hit_by_opponent_score_weight: -0.5,
            ...
            optimal_tile_direct_hit_by_opponent_score_weight: -0.5,
