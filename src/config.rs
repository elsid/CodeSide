...
pub struct Config {
    ...
    pub plan_location_distance_score_weight: f64,
...
impl Config {
    pub fn new() -> Self {
        Self {
            ...
            optimal_location_hit_by_opponent_score_weight: -5.0,
            optimal_location_opponent_obstacle_score_weight: -1.0,
            optimal_location_hit_nearest_opponent_score_weight: 10.0,
            ...
            optimal_location_hit_teammates_score_weight: -5.0,
