...
pub struct Config {
    ...
    pub optimal_location_historical_location_score_weight: f64,
    pub optimal_location_historical_neighborhood_score_weight: f64,
...
impl Config {
    pub fn new() -> Self {
        Self {
            ...
            optimal_location_historical_location_score_weight: 1.0,
            optimal_location_historical_neighborhood_score_weight: 3.0,
