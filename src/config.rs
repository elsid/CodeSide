...
impl Config {
    pub fn new() -> Self {
        Self {
            ...
            optimal_location_hit_by_opponent_score_weight: -22.0,
            optimal_location_opponent_obstacle_score_weight: -1.0,
            optimal_location_hit_nearest_opponent_score_weight: 44.0,
            ...
            optimal_location_hit_teammates_score_weight: -22.0,
