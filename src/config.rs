...
pub struct Config {
    ...
    pub plan_time_score_weight: f64,
    ...
    pub optimal_tile_bullet_track_score_weight: f64,
    pub optimal_tile_max_bullet_time: f64,
...
impl Config {
    pub fn new() -> Self {
        Self {
            ...
            optimal_tile_bullet_track_score_weight: 1.0,
            optimal_tile_max_bullet_time: 3.0,
